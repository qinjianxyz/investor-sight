...
| Real analyst workflow | Mission Control, Scenario Lab, Evidence Ledger, Change Timeline, and Demo Reliability surfaces |
| Deterministic demo reliability | `../scripts/demo-smoke.mjs`, `npm run demo:smoke`, readiness score, and stable ranking hash |
| Source trust summary | Evidence Ledger generated by `../src/analysis.ts` reports source mix, primary-source ratio, and event-source coverage |
| What changed recently as a workflow | Change Timeline generated from all structured events, sorted by freshness |
...
| Product contract tests | `../tests/cockpit-contract.test.mjs` covers analyst cockpit, required views, and demo smoke wiring |
...
- Data verifier reports 10 companies, 54 sources, top=NCLH:92, readiness=100, and ranking hash.
- Demo smoke reports readiness=100 and top=NCLH:92.
- TypeScript build reports 6 dist files present and modules import cleanly.
